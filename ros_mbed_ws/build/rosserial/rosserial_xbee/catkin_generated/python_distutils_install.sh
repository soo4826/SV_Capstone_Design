...
echo_and_run cd "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
