...
echo_and_run cd "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
