...
echo_and_run cd "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/ailab/Project/07_Mbed_ros/ros_mbed_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
